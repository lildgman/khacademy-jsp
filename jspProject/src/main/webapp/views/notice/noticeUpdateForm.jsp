    ...
    <div class="outer" align="center">
        ...
        <form action="<%=contextPath %>/update.no" id="update-form" method="POST">
            ...
            <table>
                <tr>
                    <th width="50">제목</th>
                    <td width="450"><input type="text" name="title" required value="<%=notice.getTitle()%>"></td>
                </tr>
                <tr>
                    <th>내용</th>
                </tr>
                <tr>
                    <td colspan="2">
                        <textarea name="content" cols="30" rows="10" style="resize:none"><%=notice.getContent() %></textarea>
                    </td>
                </tr>
            </table>
            ...
            <div align="center">
                <button type="submit" class="btn btn-sm text-white">수정하기</button>
